        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold">GET ME A CHAI</h3>
            </div>
            <p className="text-gray-400 text-sm">
              Empowering creators to receive support from their community, one chai at a time.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a 
                href="#" 
                className="w-10 h-10 bg-white/5 hover:bg-orange-500/20 rounded-full flex items-center justify-center transition-all duration-300 border border-white/10 hover:border-orange-500/50"
              >
